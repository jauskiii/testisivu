...
var Particle = /** @class */ (function (_super) {
    ...
    Particle.prototype.createDots = function () {
        ...
        var _b = this.options, maxR = _b.maxR, minR = _b.minR, maxSpeed = _b.maxSpeed, minSpeed = _b.minSpeed, parallaxLayer = _b.parallaxLayer, spin = _b.spin, spinMaxSpeed = _b.spinMaxSpeed, spinMinSpeed = _b.spinMinSpeed;
     ...
     * 更新元素自旋数据
     */
    Particle.prototype.updateElementRotate = function (element) {
